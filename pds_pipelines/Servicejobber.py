...
def main():
    ...
    if Oformat == 'GeoTiff-BigTiff' or Oformat == 'GeoJPEG-2000' or Oformat == 'JPEG' or Oformat == 'PNG':
        ...
        # @TODO remove hard coded path in favor of the utilities found in the conda environment.  Requires more information -
        #  we need to make sure that the utilities that are found are capable of properly supporting GeoJPEG-2000.
